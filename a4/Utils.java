...
{	public Utils() {}
	...
	public static float[] defaultAmbient() { return (new float [] {0.05f,0.05f,0.05f,1.0f});}
	public static float[] defaultDiffuse() { return (new float [] { 0.5f,0.5f,0.5f,1.0f});}
	public static float[] defaultSpecular(){ return (new float [] {0.2f,0.2f,0.2f,1.0f});}
	public static float defaultShininess() { return 60f;}
	
	
	//emerald
	public static float[] emeraldAmbient() { return (new float [] {0.0215f, 0.1745f, 0.0215f, 0.2f});}
	public static float[] emeraldDiffuse() { return (new float [] { 0.07568f, 0.61424f, 0.07568f, 0.2f});}
	public static float[] emeraldSpecular(){ return (new float [] {0.633f, 0.727811f, 0.633f, 0.2f});}
